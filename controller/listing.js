...
//     try {
//         const alisting = await listing.findById(id).populate({path:"reviews",
//             populate:
//             {
//                 path:"author"
//             }
...
//     const { id } = req.params; // Extract listing ID from route params
//     const listingData = req.body.listing; // Get the listing data from the request body

//     // Log the incoming request data to inspect
//     console.log("Request Body:", req.body);
//     console.log("Uploaded File:", req.file); // This will show the file info if uploaded

//     // Ensure that listing data is provided in the request body
//     if (!listingData) {
//         throw new ExpressError(400, "Send valid data for listing");
//     }

//     try {
//         let imageUrl = ''; // Default empty value
//         let imageFilename = ''; // Default empty value

//         // If a new file is uploaded, use the new image URL and filename
//         if (req.file) {
//             imageUrl = req.file.path; // Cloudinary URL for the new image
//             imageFilename = req.file.filename; // Cloudinary's unique filename
//         }

//         // If no file is uploaded, check if the image data was included in the request
//         else {
//             // If there is no new image uploaded, use existing image info from the database
...
//             // Fallback to existing image data if not updated
...
//                 image: { url: imageUrl, filename: imageFilename }, // Store the updated image info
//             },
//             { new: true } // `new: true` returns the updated document
//         );

//         // If listing is not found, throw a 404 error
//         if (!updatedListing) {
//             return next(new ExpressError(404, "Listing not found"));
//         }
